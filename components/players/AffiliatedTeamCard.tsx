  ...
  return (
    ...
    >
      ...
      <span className="flex min-w-0 flex-1 flex-col gap-1">
        <span className="text-xs font-medium text-zinc-500">Équipe actuelle</span>
      ...
      <span className="hidden text-sm text-zinc-400 group-hover:text-orange-400 sm:inline">
        Voir le roster
      </span>
    </Link>
  );
