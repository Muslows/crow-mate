...
function fromAddress(): string {
  return process.env.EMAIL_FROM?.trim() || "OW Manager <noreply@ow-manager.local>";
}
...
export function authEmailHtml(opts: {
  ...
  return `<!doctype html>
<html>
  <body style="margin:0;background:#090d16;color:#f4f4f5;font-family:Inter,system-ui,sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="padding:32px 16px;">
      <tr>
        <td align="center">
          <table role="presentation" width="100%" style="max-width:480px;background:#171717;border:1px solid #27272a;border-radius:16px;padding:28px;">
            <tr><td style="font-size:13px;color:#fb923c;font-weight:700;">OW Manager</td></tr>
            ...
            <tr>
              <td style="padding-top:24px;">
                <a href="${opts.href}" style="display:inline-block;background:#ea580c;color:#fff;text-decoration:none;font-weight:600;font-size:14px;padding:10px 18px;border-radius:999px;">${opts.cta}</a>
              </td>
            </tr>
