...
const SCHEMA_STATEMENTS = [
  ...
  createEnumSql("TeamOrgRole", ["PLAYER", "CAPTAIN", "COACH", "MANAGER"]),
  ...
  `DO $$ BEGIN ALTER TABLE "TeamTimeSlot" ADD CONSTRAINT "TeamTimeSlot_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `INSERT INTO "TeamTimeSlot" ("id", "teamId", "label", "startTime", "endTime", "sortOrder") SELECT 'tts20_' || t."id", t."id", '20h - 22h', '20:00', '22:00', 0 FROM "Team" t ON CONFLICT ("id") DO NOTHING`,
  `INSERT INTO "TeamTimeSlot" ("id", "teamId", "label", "startTime", "endTime", "sortOrder") SELECT 'tts21_' || t."id", t."id", '21h - 23h', '21:00', '23:00', 1 FROM "Team" t ON CONFLICT ("id") DO NOTHING`,
  ...
  createEnumSql("ConversationContextType", [
    "DIRECT",
    "RECRUITMENT",
    "SCRIM",
    "OPEN_POSITION",
  ]),
  `DO $$ BEGIN ALTER TYPE "ConversationContextType" ADD VALUE 'OPEN_POSITION'; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `CREATE TABLE IF NOT EXISTS "Conversation" (
    "id" TEXT NOT NULL,
    "recruiterId" TEXT NOT NULL,
    "candidateId" TEXT NOT NULL,
    "contextType" "ConversationContextType" NOT NULL DEFAULT 'DIRECT',
    "contextKey" TEXT NOT NULL DEFAULT 'direct',
    "contextTeamId" TEXT,
    "scrimProposalId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "Conversation_pkey" PRIMARY KEY ("id")
  )`,
  `ALTER TABLE "Conversation" ADD COLUMN IF NOT EXISTS "contextType" "ConversationContextType" NOT NULL DEFAULT 'DIRECT'`,
  `ALTER TABLE "Conversation" ADD COLUMN IF NOT EXISTS "contextKey" TEXT NOT NULL DEFAULT 'direct'`,
  `ALTER TABLE "Conversation" ADD COLUMN IF NOT EXISTS "contextTeamId" TEXT`,
  `ALTER TABLE "Conversation" ADD COLUMN IF NOT EXISTS "scrimProposalId" TEXT`,
  ...
  `DROP INDEX IF EXISTS "Conversation_recruiterId_candidateId_key"`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "Conversation_recruiterId_candidateId_contextKey_key" ON "Conversation"("recruiterId", "candidateId", "contextKey")`,
  `CREATE INDEX IF NOT EXISTS "Conversation_recruiterId_updatedAt_idx" ON "Conversation"("recruiterId", "updatedAt")`,
  `CREATE INDEX IF NOT EXISTS "Conversation_candidateId_updatedAt_idx" ON "Conversation"("candidateId", "updatedAt")`,
  `CREATE INDEX IF NOT EXISTS "Conversation_contextTeamId_idx" ON "Conversation"("contextTeamId")`,
  `CREATE INDEX IF NOT EXISTS "Conversation_scrimProposalId_idx" ON "Conversation"("scrimProposalId")`,
  `CREATE INDEX IF NOT EXISTS "ChatMessage_conversationId_createdAt_idx" ON "ChatMessage"("conversationId", "createdAt")`,
  `CREATE INDEX IF NOT EXISTS "ChatMessage_conversationId_isRead_idx" ON "ChatMessage"("conversationId", "isRead")`,
  `CREATE INDEX IF NOT EXISTS "ChatMessage_isRead_senderId_idx" ON "ChatMessage"("isRead", "senderId")`,
  `CREATE INDEX IF NOT EXISTS "ChatMessage_senderId_idx" ON "ChatMessage"("senderId")`,
  `DO $$ BEGIN ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_recruiterId_fkey" FOREIGN KEY ("recruiterId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `DO $$ BEGIN ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_candidateId_fkey" FOREIGN KEY ("candidateId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `DO $$ BEGIN ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_contextTeamId_fkey" FOREIGN KEY ("contextTeamId") REFERENCES "Team"("id") ON DELETE SET NULL ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `DO $$ BEGIN ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_scrimProposalId_fkey" FOREIGN KEY ("scrimProposalId") REFERENCES "ScrimProposal"("id") ON DELETE SET NULL ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `DO $$ BEGIN ALTER TABLE "ChatMessage" ADD CONSTRAINT "ChatMessage_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "Conversation"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
  `DO $$ BEGIN ALTER TABLE "ChatMessage" ADD CONSTRAINT "ChatMessage_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE; EXCEPTION WHEN duplicate_object THEN NULL; END $$`,
];
